# Introduction to coding smart contracts with Solidity using TDD
A small iteration on how to code smart contracts using parts of the TDD methodology

## Instructions

Fork this repository and create a Hardhat project to code the smart contract and make all the tests pass.
